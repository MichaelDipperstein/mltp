/***************************************************************************
*         Matrix-to-Matrix Multiplication with Dynamic Scheduling
*
*   File    : mdyn_mm.c
...
*
*   $Id: mdyn_mm.c,v 1.2 2000/08/21 20:22:20 mdipper Exp $
****************************************************************************
*
...
*       The multiplications scheduled each pass
...
/****************************************************************************
*   Function   : PrintA
*   Description: This function writes the contents of matrix A to stdout.
*   Parameters : None
*   Effects    : The contents of matrix A are written to stdout
*   Returned   : None
****************************************************************************/
void printA()
{
...
/****************************************************************************
*   Function   : PrintB
*   Description: This function writes the contents of matrix B to stdout.
*   Parameters : None
*   Effects    : The contents of matrix B are written to stdout
*   Returned   : None
****************************************************************************/
void printB()
{
...
*                gets a chunk of avaiable task IDs and then calls the
*                routines to perform the multiplication for those tasks.
*   Parameters : arg - not used.
*   Effects    : Thread will schedule and complete its multiplication tasks
*   Returned   : None
*
*   NOTE: Under mltp a thread started by this function will not release its
*         VP until no more multiplications are available.  If there are not
*         enough VPs to go around, then extra threads will not have any work
*         to do.
****************************************************************************/
void work(void *arg)
{
...
int main(int argc, char *argv[])
{
    ...
    /* create data space for matricies */
    ...
    mltp_init();
    mltp_lock_init(&lock, MLTP_LOCK_STD);
